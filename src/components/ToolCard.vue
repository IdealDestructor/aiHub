<template>
  <div
    ...
    @click="openToolLink"
    :class="{ 'compact-mode': isCompact, 'minimal-mode': isMinimal }"
  >
    <div v-if="isMinimal" class="minimal-content" @click.stop="goToTool">
      <div class="minimal-header">
        ...
        <button
          class="btn icon-btn favorite-btn"
      ...
      <div class="minimal-footer">
        ...
        <button class="btn visit-btn" style="justify-content: end">
          访问 <i class="fa-solid fa-arrow-right"></i>
        </button>
      </div>
    </div>
    ...
    <template v-else>
      ...
      <div class="tool-actions">
        <a :href="tool.url" target="_blank" class="btn primary" @click.stop
          >立即使用</a
        >
        <button
...
h2,
h3,
span:not(.tool-type):not(.tool-category) {
  cursor: default;
}
